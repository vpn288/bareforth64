...
; Search the implemented ports for a drive
	mov eax, [rsi+0x0C]		; PI вЂ“ Ports Implemented
	mov edx, eax
	xor ecx, ecx
...
founddrive:
	...
	stosd				; Offset 00h: PxCLB вЂ“ Port x Command List Base Address
	xor eax, eax
	stosd				; Offset 04h: PxCLBU вЂ“ Port x Command List Base Address Upper 32-bits
	mov rax, ahci_cmdlist + 0x1000	; 256 or 4096 bytes per port
	stosd				; Offset 08h: PxFB вЂ“ Port x FIS Base Address
	xor eax, eax
	stosd				; Offset 0Ch: PxFBU вЂ“ Port x FIS Base Address Upper 32-bits
	stosd				; Offset 10h: PxIS вЂ“ Port x Interrupt Status
	stosd				; Offset 14h: PxIE вЂ“ Port x Interrupt Enable
